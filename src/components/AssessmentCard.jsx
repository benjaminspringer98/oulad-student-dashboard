export default function AssessmentCard({assessment}) {
    return (
        ...
        <div
            ...
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{assessment[0]}</h5>
            <h6 className="mb-2 text-xl tracking-tight text-gray-900 dark:text-white">{assessment[1]}</h6>
            <h6>{assessment[3]}</h6>
            <h6>{assessment[4]}</h6>
        </div>
